...
public class DepPlaceholderAPI extends PlaceholderExpansion {
    ...
    public String getIdentifier() {
        return BetterRTP.getInstance().getPluginMeta().getName().toLowerCase();
    }

    @NotNull
    @Override
    public String getAuthor() {
        return BetterRTP.getInstance().getPluginMeta().getAuthors().get(0);
    }

    @NotNull
    @Override
    public String getVersion() {
        return BetterRTP.getInstance().getPluginMeta().getVersion();
    }
